...
def update_user(request, user_id):
    ...
    User.objects.filter(pk=user_id).update(first_name=firstName, middle_name=middleName, last_name=lastName, age=age, birth_date=birthDate, username=username, gender_id=genderId) 
